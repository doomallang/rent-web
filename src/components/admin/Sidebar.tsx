...
export default function Sidebar({ onClose }: SidebarProps) {
  ...
  const visibleItems = navItems.filter((item) => !item.superOnly || user?.role === "super");
    ...
    <div className="flex flex-col h-full bg-gray-900 text-gray-300 w-64">
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b border-gray-800">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-white font-bold text-sm leading-none">드라이브온</p>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-gray-500 text-xs truncate">
                {user.role === "super" ? "슈퍼관리자" : user.companyName}
              </p>
            </div>
          </div>
        </div>
